...
import photo from "./SocialLinks/photo_resume.jpg";
      ...
      <div className="w-full flex justify-around">
        ...
        >
          <div className="w-40 h-40 rounded-full  image">
            <img src={photo} className="w-screen rounded-lg" />
          </div>
          <h1
          ...
          <div className=" w-96 p-2 flex gap-2 justify-center relative lg:top-10 sm:top-14">
            ...
            >
              <a href="https://www.linkedin.com/in/rohit-prajapati-b6895b250/">
                {" "}
            ...
            >
              <a href="https://github.com/rohitritik" target="#">
                {" "}
