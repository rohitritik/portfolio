...
import project2 from "../Components/SocialLinks/download_job.jpeg"
import project3 from "../Components/SocialLinks/download_eco.jpeg"
      ...
      {/* <div className="p-3"> */}
        <div className={` ${darkmode==="dark" ? `bg-${bgcolor}` : `bg-white`} p-10 rounded-lg`}>
          ...
          <a href="https://amazing-toffee-71729d.netlify.app">
            ...
            <a href="https://job-seeking-web-app-codewithrohit.netlify.app/">
            <div
              className="ui-ux-design w-80 flex flex-col gap-3 p-5 rounded-lg"
            ...
            >
              ...
              <div>
                ...
                <h1 className={`text-md font-bold ${bgcolor==="white" ? "text-black" :"text-white"}`}>Job Seeking Application (ReactJs, NodeJs, MongoDB, Express)</h1>
              </div>
            </div>
            </a>

            <a href="https://myappp-e2603.web.app/">
            <div
              className="ui-ux-design w-80 flex flex-col gap-3 p-5 rounded-lg"
              style={{background:`${bgcolor==="white" ? "#FFF4F4" :"black"}`,  border:`${bgcolor==="white" ? "none" :"1px solid #A6A6A6"}`}}
            >
              ...
              <div>
                ...
                <h1 className={`text-md font-bold ${bgcolor==="white" ? "text-black" :"text-white"}`}>E-Commerce Application (ReactJs, Firebase, TailwindCSS, Razorpay)</h1>
              </div>
            </div>
            </a>
          </div>
