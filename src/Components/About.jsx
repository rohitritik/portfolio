    ...
    <>
      <div className="relative h-full">
        <div className={`${darkmode==="dark" ? `bg-${bgcolor}` : `bg-white`} p-10 rounded-lg`}>
          ...
          >
            I have Completed My <span className="font-bold">B.Tech Degree </span>From Guru Jambheshwar University of Science <br /> And Technology, Hisar.  
            My Specilization in <span className="font-bold">Computer Science And Engineering (CSE)</span>
